...
describe('CourseListRow Component', () => {
    it('Renders one <th> with colspan=2 when isHeader is true and textSecondCell is null', () => {
        render(
            <table>
                <thead>
                    <CourseListRow isHeader={true} textFirstCell="H1" textSecondCell={null} />
                </thead>
            </table>
        );
    ...
    it('Renders two <th> cells when isHeader is true and textSecondCell is present', () => {
        render(
            <table>
                <thead>
                    <CourseListRow isHeader={true} textFirstCell="H1" textSecondCell="H2" />
                </thead>
            </table>
        );
    ...
    it('Renders two <td> elements when isHeader is false', () => {
        render(
            <table>
                <tbody>
                    <CourseListRow isHeader={false} textFirstCell="C1" textSecondCell="C2" />
                </tbody>
            </table>
        );
